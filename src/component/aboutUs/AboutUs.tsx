...
export default function AboutUs() {
  return (
    <section className='w-full flex items-center justify-center py-[35px]'>
      <div className="w-full max-w-7xl flex flex-col gap-[80px]">
        <div className='flex gap-5 items-center flex-wrap justify-center'>
          <div className='max-w-xs w-full rounded-[10px]'>
            <img src={firstImg} alt='' className='w-[100%] h-[100%] object-contain' />
          </div>
        ...
        <div className='flex gap-5 items-center justify-center flex-wrap'>
          ...
          <div className='max-w-xs w-full rounded-[10px]'>
            <img src={secondImg} alt='' className='w-[100%] h-[100%] object-contain' />
          </div>
        </div>
        <div className='flex gap-5 items-center justify-center flex-wrap'>
          <div className='max-w-xs w-full rounded-[10px]'>
            <img src={thirdImg} alt='' className='w-[100%] h-[100%] object-contain' />
          </div>
          <div className='max-w-3xl w-full rounded-[10px] bg-[#050044] border-1 border-[#155DFC] text-white p-14 text-left'>
